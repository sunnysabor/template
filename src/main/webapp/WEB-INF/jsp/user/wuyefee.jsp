...
<head>
    ...
    <script type="text/javascript">
        ...
        function chaxun() {
            ...
            var res_id = $("#res_id").val() == "" ? 0 : $("#res_id").val();
            $.ajax({
                /* async : false,
                cache : false, */
                type: "POST",
                url: "ParkingServlet?op=queryChargCount&res_id="+res_id+"&year=" + year + "&month=" + month + "",
                dataType: 'json',
                error: function (data) {
                    alert(data);
                },
...
<body>
<center>
    <span style="display: none;" id="res_id">${userinfo.res_id }</span>
