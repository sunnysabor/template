...
<%@page import="com.taobao.chenbao.template.entity.Student" %>
...
<%
    ...
    Student str = (Student) request.getSession().getAttribute(
            "userinfo");
    if (str == null) {
...
<div region="north" style="height: 80px;background-color: #E0EDFF">
    ...
    <div
        ...
        当前用户：&nbsp;<font color="#CD0000" style="font-size: 15px">${userinfo.name }先生</font>
        <div id="result">
        </div>
    </div>
    <%
    ...
    <div
            id="tips" style="padding-top: 20px; padding-right: 20px;float:right;margin-right: 50px;font-size: 13px;">
        当前用户：&nbsp;<font color="#CD0000" style="font-size: 15px">${userinfo.name }女士</font>
        <div id="result">
        </div>
    </div>
    <%
